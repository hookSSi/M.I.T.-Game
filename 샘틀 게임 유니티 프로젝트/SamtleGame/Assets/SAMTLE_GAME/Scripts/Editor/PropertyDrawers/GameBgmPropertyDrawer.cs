...
{
    [CustomPropertyDrawer(typeof(GameBgmAttribute))]
    public class GameBgmPropertyDrawer : PropertyDrawerBase 
    {
		...
		protected override void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label)
		{
			...
			{
				var bgmsProperty = BgmManager.Instance._sounds;
			...
			{
				string message = string.Format("{0}는 string 필드만 지원합니다.", typeof(GameBgmAttribute).Name);
