...
{
    public class PokemonBattleDialogueBox : DialogueBox
    {
        /*
        public bool _isLastPage = false;
        public bool _isPageEnded = false;

        public void Talk(string sound, DialogueStatus status)
        {
            _id = 0;
            DialogueEvent.Trigger(_id, _textPages, _currentPage, sound, status);
        }
        ...
        public void AddNextPage(string nextScript)
        {
            DialoguePage newPage = new DialoguePage();
            newPage._text = nextScript;
